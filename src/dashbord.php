...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <!-- Liste des contacts -->
        <div class="col-md-8">
            <form action="./treatment/contact_delete.php" method="POST" enctype=multipart/form-data>
                <div class="d-flex justify-content-between mb-2">
                    <h3>Liste des Contacts</h3> 
                    <button type="submit" name="btnSelection" class="btn btn-primary">Supprimer Sélection</button>
                </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="./treatment/contact_delete.php?id_contact=<?=$row['id']; ?>"> 
